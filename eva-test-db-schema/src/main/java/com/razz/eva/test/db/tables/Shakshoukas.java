...
public class Shakshoukas extends TableImpl<ShakshoukasRecord> {
     ...
     */
    public final TableField<ShakshoukasRecord, ShakshoukasState> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.razz.eva.test.db.enums.ShakshoukasState.class), this, "");
