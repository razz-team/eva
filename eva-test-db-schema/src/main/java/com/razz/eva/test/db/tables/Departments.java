...
public class Departments extends TableImpl<DepartmentsRecord> {
     ...
     */
    public final TableField<DepartmentsRecord, DepartmentsState> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.razz.eva.test.db.enums.DepartmentsState.class), this, "");
