...
public class UowEventsTemplateRecord extends TableRecordImpl<UowEventsTemplateRecord> implements Record10<UUID, String, String, String, String, Instant, Instant, UUID[], String, Long> {
    ...
    /**
     * Getter for <code>events.uow_events_template.id</code>.
     */
    public UUID getId() {
        return (UUID) get(0);
    }
    ...
    @Override
    public UowEventsTemplateRecord value6(Instant value) {
        setOccurredAt(value);
        return this;
    }
    ...
    @Override
    public UowEventsTemplateRecord value8(UUID[] value) {
        setModelEvents(value);
        return this;
    }

    @Override
    public UowEventsTemplateRecord value9(String value) {
        setParams(value);
        return this;
    }

    @Override
    public UowEventsTemplateRecord value10(Long value) {
        setIncrementalQueryId(value);
        return this;
    }

    @Override
    public UowEventsTemplateRecord values(UUID value1, String value2, String value3, String value4, String value5, Instant value6, Instant value7, UUID[] value8, String value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UowEventsTemplateRecord(UUID id, String name, String idempotencyKey, String principalName, String principalId, Instant occurredAt, Instant insertedAt, UUID[] modelEvents, String params, Long incrementalQueryId) {
        super(UowEventsTemplate.UOW_EVENTS_TEMPLATE);
