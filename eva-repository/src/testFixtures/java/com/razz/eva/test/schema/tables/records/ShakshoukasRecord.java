...
public class ShakshoukasRecord extends UpdatableRecordImpl<ShakshoukasRecord> implements com.razz.jooq.record.TypedStatefulModelRecord<UUID, ShakshoukasState>, Record8<UUID, UUID, ShakshoukasState, String, Boolean, Instant, Instant, Long> {
